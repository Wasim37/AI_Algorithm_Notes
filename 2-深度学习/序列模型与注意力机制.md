...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Seq2Seq.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Image-captioning.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Beam-search.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Error-analysis-process.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Bleu-score-on-unigram.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Attention-Model.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Computing-attention.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Attention-model-for-speech-recognition.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/CTC-for-speech-recognition.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/训练模型与注意力机制/Trigger-word-detection-algorithm.png)
