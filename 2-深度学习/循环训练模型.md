...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424212312_Examples-of-Sequence-Model.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/Recurrent-Neural-Network.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424211053_1.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424211053_2.png)

![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180425095414.png)
...
更详细的计算公式如下：
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/formula-of-RNN.png)

**附DNN前向反向传播公式**：
![前向传播](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/深度学习/前向传播.png)
![反向传播](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/深度学习/反向传播.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/Examples-of-RNN-architectures.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/language-model-RNN-example.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/Sampling-a-sequence-from-a-trained-RNN.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424211053_3.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424211053_4.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/20180424211053_5.png)

![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/LSTM.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/BRNN.png)
...
![](http://hexo-blog-wasim.oss-cn-shenzhen.aliyuncs.com/循环训练模型/DRNN.png)
